...
Feature: Default
	...
	@B33G9-161
	Scenario: US014AC02TC02 - Verify that any amount of boxes can be unchecked
		Scenario Outline: US014AC02TC02 Verify that <userType> see all 5 filter options as checked by default and can uncheck any amount of filter options.
			Given the user is logged in as "<userType>"
				When the user clicks on Campaign module under Marketing tab
				When the user clicks to the filter icon
